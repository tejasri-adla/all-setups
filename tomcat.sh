...
sed -i '58  a\<user username="tomcat" password="admin@123" roles="manager-gui, manager-script"/>' apache-tomcat-11.0.21/conf/tomcat-users.xml
sed -i '511  a\</tomcat-users>' apache-tomcat-11.0.21/conf/tomcat-users.xml
